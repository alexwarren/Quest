...
namespace WebEditor2.Services
{
    public class EditorService
    {
        ...
        public Models.Element GetElementModelForView(int gameId, string key, string tab, string error, string refreshTreeSelectElement, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
        ...
        public Models.Script GetScriptModel(int id, string key, IEditorControl ctl, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
        ...
        public Models.Script GetScriptModel(int id, string key, IEditableScripts value, string attribute, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
        ...
        public Models.ScriptDictionary GetScriptDictionaryModel(int id, string key, IEditorControl ctl, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
        ...
        public Models.ScriptDictionary GetScriptScriptDictionaryModel(int id, string key, string path, IEditorControl ctl, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
            string parameter;
            IEditableScript scriptLine = GetScriptLine(key, path, out parameter);
            IEditorData scriptEditorData = m_controller.GetScriptEditorData(scriptLine);
        ...
        private Models.ScriptDictionary GetScriptDictionaryModel(int id, string key, IEditableDictionary<IEditableScripts> value, IEditorControl ctl, string attribute, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
            return GetScriptDictionaryModel(id, key, value, ctl.GetString("keyprompt"), ctl.GetString("source"), attribute, modelState);
        }

        public Models.ScriptDictionary GetScriptDictionaryModel(int id, string key, IEditableDictionary<IEditableScripts> value, string keyPrompt, string source, string attribute, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
        ...
        public Models.StringDictionary GetStringDictionaryModel(int id, string key, IEditorControl ctl, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState)
        {
        ...
        public Models.StringDictionary GetStringDictionaryModel(int id, string key, IEditorControl ctl, Microsoft.AspNetCore.Mvc.ModelBinding.ModelStateDictionary modelState, bool gameBook)
        {
